        ...
        try:
            ...
            for row in cursor:
                ...
                list.append(Contact(id=str(id), firstname=firstname, middlename=middlename, lastname=lastname,
                                    ...
                                    homenumber=home, mobilenumber=mobile, worknumber=work, fax=fax, email=email,
                                    email2=email2, email3=email3, homepage=homepage, bday=str(bday), bmonth=bmonth,
                                    byear=byear, aday=str(aday), amonth=amonth, ayear=ayear, address2=address2,
